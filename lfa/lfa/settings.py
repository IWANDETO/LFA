"""
Django settings for lfa project.
...
SECRET_KEY = 'django-insecure-taq9_l7j4(niith&5+5oqj=ajgjc!ofqu7(negx!#&51988)7m'
...
WSGI_APPLICATION = 'lfa.wsgi.application'
